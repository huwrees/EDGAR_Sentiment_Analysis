...
def get_sp100():
    ...
    """
    return ["AAPL", "MSFT", "AMZN", "BRK-B", "GOOGL", "UNH", "GOOG", "JNJ", "XOM", "JPM", "NVDA", "PG", "V", "HD", "TSLA", "CVX", "MA", "LLY", "ABBV", "PFE", "MRK", "META", "PEP", "KO", "BAC", "AVGO", "TMO", "COST", "WMT", "MCD", "ABT", "ADBE", "CSCO", "NFLX", "ORCL", "INTC", "CRM", "VZ", "QCOM", "PM", "DHR", "NKE", "C", "UNP", "T", "PNC", "PYPL", "WFC", "NEE", "PDD", "TMUS", "UPS", "ACN", "IBM", "TXN", "HON", "AMGN", "LIN", "LMT", "GILD", "MU", "TGT", "RTX", "AZN", "AON", "BMY", "SBUX", "CME", "LOW", "MDT", "UPS", "GS", "MDT", "MCO", "AMAT", "CAT", "AXP", "ABNB", "BLK", "CVNA", "COP", "CVS", "DOW", "GSK", "LVS", "TM", "ADI", "DUK", "ILMN", "MMM", "SO", "AIG", "BIIB", "CL", "D", "DIS", "DUK", "FDX", "GM", "KMB", "MDLZ", "MO", "NEE", "NVO", "PBR", "PSX", "RACE", "SO", "TMX", "UBER", "VLO"]
